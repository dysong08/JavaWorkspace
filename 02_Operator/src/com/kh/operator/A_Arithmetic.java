...
public class A_Arithmetic {
	...
	public void method() {
		...
		// num1 + num2 로 출력해버리면 String처럼 각각의 숫자 10과 3을 찍기 때문에 103이 출력된다.
		// 괄호로 묶어서 먼저 산술연산처리를 해줘야 함
		
		System.out.println("num1 - num2 = " + (num1 - num2));
		// 뺄셈은 괄호로 묶어두지 않는 경우 숫자로 인식하기 때문에 에러발생함.
		
		System.out.println("num1 * num2 = " + num1 * num2);
		System.out.println("num1 / num2 = " + num1 / num2);
		System.out.println("num1 % num2 = " + num1 % num2);
		// 곱셈, 나눗셈, 모듈러 연산의 경우 +,-보다 우선순위가 높기 때문에 괄호를 묶어주지 않아도 정확한 결과가 나온다.
